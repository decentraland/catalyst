...
import { CURRENT_VERSION, CURRENT_COMMIT_HASH, Environment, EnvironmentConfig } from './Environment.js'
import { splitByCommaTrimAndRemoveEmptyElements } from './logic/config-helpers.js'
import { metricsDeclaration } from './metrics.js'
import { createMigrationExecutor } from './migrations/migration-executor.js'
import { createActiveEntitiesComponent } from './ports/activeEntities.js'
import { createClock } from './ports/clock.js'
import { createCustomDAOComponent, createDAOComponent } from './ports/dao-servers-getter.js'
import { createDenylist } from './ports/denylist.js'
import { createDeployRateLimiter } from './ports/deployRateLimiterComponent.js'
import { createDeployedEntitiesBloomFilter } from './ports/deployedEntitiesBloomFilter.js'
import { createDeployer } from './ports/deployer.js'
import { createFailedDeployments } from './ports/failedDeployments.js'
import { createDatabaseComponent } from './ports/postgres.js'
import { createProcessedSnapshotStorage } from './ports/processedSnapshotStorage.js'
import { createSequentialTaskExecutor } from './ports/sequecuentialTaskExecutor.js'
import { createSnapshotGenerator } from './ports/snapshotGenerator.js'
import { createSnapshotStorage } from './ports/snapshotStorage.js'
import { createSynchronizationState } from './ports/synchronizationState.js'
import { createSystemProperties } from './ports/system-properties.js'
...
import { ChallengeSupervisor } from './service/synchronization/ChallengeSupervisor.js'
import { ContentCluster } from './service/synchronization/ContentCluster.js'
import { createBatchDeployerComponent } from './service/synchronization/batchDeployer.js'
import { createRetryFailedDeployments } from './service/synchronization/retryFailedDeployments.js'
import { createServerValidator } from './service/validations/server.js'
import {
  createExternalCalls,
