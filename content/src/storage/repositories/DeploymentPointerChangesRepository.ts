...
export class DeploymentPointerChangesRepository {
    ...
    async getPointerChangesForDeployments(deploymentIds: DeploymentId[]): Promise<Map<DeploymentId, Map<Pointer, { before: EntityId | undefined, after: DELTA_POINTER_RESULT }>>> {
