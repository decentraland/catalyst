...
export const DEFAULT_DCL_COLLECTIONS_ACCESS_URL_ROPSTEN = 'https://api.thegraph.com/subgraphs/name/decentraland/collections-ropsten'
...
export class EnvironmentBuilder {
    ...
    async build(): Promise<Environment> {
        ...
        this.registerConfigIfNotAlreadySet(env, EnvironmentConfig.PSQL_PASSWORD                  , () => process.env.POSTGRES_CONTENT_PASSWORD ?? DEFAULT_DATABASE_CONFIG.password)
        this.registerConfigIfNotAlreadySet(env, EnvironmentConfig.PSQL_USER                      , () => process.env.POSTGRES_CONTENT_USER ?? DEFAULT_DATABASE_CONFIG.user)
        this.registerConfigIfNotAlreadySet(env, EnvironmentConfig.PSQL_DATABASE                  , () => process.env.POSTGRES_CONTENT_DB ?? DEFAULT_DATABASE_CONFIG.database)
