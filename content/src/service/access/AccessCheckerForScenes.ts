...
export class AccessCheckerForScenes {
    ...
    private async getParcel(x: number, y: number, timestamp: Timestamp): Promise<Parcel|undefined> {
        ...
        try {
            return (await this.fetcher.queryGraph<{parcels: Parcel[]}>(this.dclParcelAccessUrl, query, variables)).parcels[0]
        } catch (error) {
    ...
    private async getEstate(estateId: string, timestamp: Timestamp): Promise<Estate|undefined> {
        ...
        try {
            return (await this.fetcher.queryGraph<{estates: Estate[]}>(this.dclParcelAccessUrl, query, variables)).estates[0]
        } catch (error) {
    ...
    private async getAuthorizations(owner: EthAddress, operator: EthAddress, timestamp: Timestamp): Promise<Authorization[]> {
        ...
        try {
            return (await this.fetcher.queryGraph<{authorizations: Authorization[]}>(this.dclParcelAccessUrl, query, variables)).authorizations
        } catch (error) {
