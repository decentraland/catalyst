...
describe('AccessCheckerImpl', function () {
  ...
  it(`Invalid Wearables pointers are reported as errors`, async () => {
    ...
    expect(errors).toContain(
      'Wearable pointers should only contain the collection id and the item id separated by a hyphen, for example (0xd148b172f8f64b7a42854447fbc528f41aa2258e-0). Invalid pointer: (invalid_pointer)'
    )
  })
  ...
  it(`Invalid Wearables pointers are reported as errors`, async () => {
    ...
    expect(errors).toContain(
      'Wearable pointers must contain the collection id and the item id separated by a hyphen, for example (0xd148b172f8f64b7a42854447fbc528f41aa2258e-0). Invalid pointer: (invalid_pointer-)'
    )
  })
