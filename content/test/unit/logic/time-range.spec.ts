...
it('should satisfy progression', () => {
  ...
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 1), 'I')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 7), 'IIIIIII')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 8), 'WI')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 14), 'WIIIIIII')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 15), 'WWI')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 21), 'WWIIIIIII')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 22), 'WWWI')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 28), 'WWWIIIIIII')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 29), 'WWWWI')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 34), 'WWWWIIIIII')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 35), 'WWWWIIIIIII')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 36), 'MWI')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 42), 'MWIIIIIII')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 43), 'MWWI')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 49), 'MWWIIIIIII')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 50), 'MWWWI')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 56), 'MWWWIIIIIII')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 57), 'MWWWWI')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 63), 'MWWWWIIIIIII')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 64), 'MMWI')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 364), 'MMMMMMMMMMMMWWWIIIIIII')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 365), 'MMMMMMMMMMMMWWWWI')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 370), 'MMMMMMMMMMMMWWWWIIIIII')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 371), 'MMMMMMMMMMMMWWWWIIIIIII')
  expectTimeDivisionMatchesRepresentation(timeRangeFor(1640995200, 372), 'YMWI')
})
