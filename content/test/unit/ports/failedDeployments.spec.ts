...
describe('failed deployments', () => {
  ...
  it('should return all failed deployments from db after start', async () => {
    const failedDeployments = await createAndStartFailedDeployments({ metrics, database }, [aFailedDeployment])
  ...
  it('should remove failed deployment', async () => {
    ...
    const failedDeployments = await createAndStartFailedDeployments({ metrics, database }, failedDeploymentsMock)
  ...
  it('should report failure when there wasn`t a failed deployment with the same entity id', async () => {
    ...
    const failedDeployments = await createAndStartFailedDeployments(components, [aFailedDeployment])
...
async function createAndStartFailedDeployments(
