...
describe("CircularBuffer", () => {
  ...
  it("can write and read simple operations", () => {
    ...
    expect(buffer.read()).toEqual(Float32Array.of(10, 20, 30));

    buffer.write(Float32Array.of(40, 50, 60));
    expect(buffer.read()).toEqual(Float32Array.of(40, 50, 60));
  });
  ...
  it("can write multiple and read once", () => {
    ...
    expect(buffer.read()).toEqual(Float32Array.of(10, 20, 30, 40, 50, 60));
  });
  ...
  it("can write when the buffer is full, overwriting the first values", () => {
    ...
    expect(buffer.read()).toEqual(expected);
  });
