...
async function internalContents(fetcher: SmartContentServerFetcher, res: Response, contract: string, option: string, selector: (WearableMetadata: WearableMetadata) => string |undefined) {
    try {
...
function createExternalContentUrl(fetcher: SmartContentServerFetcher, entity: Entity, fileName: string | undefined): string | undefined {
...
function createRelativeContentUrl(fetcher: SmartContentServerFetcher, entity: Entity, fileName: string | undefined): string | undefined {
    if (fileName) {
