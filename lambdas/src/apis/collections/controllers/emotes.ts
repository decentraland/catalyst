...
// import { createThirdPartyResolver } from '../../../utils/third-party'
...
//   try {
//     const emoteIdsByOwner = collectionId
//       ? await (await createThirdPartyResolver(theGraphClient, collectionId as string)).findWearableUrnsByOwner(owner)
//       : await theGraphClient.findEmoteIdsByOwner(owner)
...
//     ? await fetchDefinitions(emoteIdsByOwner, client)
//     : new Map()

//   // Count wearables by user
//   const count: Map<EmoteId, number> = new Map()
//   for (const emoteId of emoteIdsByOwner) {
//     const amount = count.get(emoteId) ?? 0
//     count.set(emoteId, amount + 1)
//   }
