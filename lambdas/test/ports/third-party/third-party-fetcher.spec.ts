import { buildRegistryOwnerUrl, createThirdPartyAssetFetcher } from "../../../src/ports/third-party/third-party-fetcher"
...
describe('createThirdPartyFetcher', () => {
  it('should iterate until all assets have been fetched', async () => {
    ...
    const thirdPartyFetcher = createThirdPartyAssetFetcher(httpFetcher)
