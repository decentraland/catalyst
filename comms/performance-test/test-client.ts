    ...
    promises.push(
      new Promise(async (resolve, reject) => {
        try {
          ...
          const url = `${clientUrl}?sessionId=${i}&numberOfPeers=1&testId=${testId}&lighthouseUrl=${lighthouseUrl}&statsServerUrl=${statsServerUrl}&testDuration=${testDuration}&peerIdLength=${peerIdLength}`;
